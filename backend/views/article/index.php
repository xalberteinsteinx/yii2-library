 ...
 * @var $searchModel    xalberteinsteinx\library\common\search\ArticleSearch
 * @var $dataProvider   yii\data\ActiveDataProvider
 */

$this->title = Yii::t('library', 'List of articles');
                ...
                [
                    ...
                    'value' => function ($model) {
                        ...
                        if (!empty($model->translation->title)) {
                            ...
                            $content .= '<small>' . \Yii::t('library', 'Created by') . ' ' . $owner->email . '</small><br>';
                        }
                        return $content;
                    },
