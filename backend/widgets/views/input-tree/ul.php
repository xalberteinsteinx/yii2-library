...
<ul class="input-tree-ul">
    <?php foreach ($parents as $object): ?>
        <?php
        $children = \xalberteinsteinx\library\backend\widgets\InputTree::findChildren($object, $object->id);
        ...
        <li>
            ...
            <?= $this->render(
                '@vendor/xalberteinsteinx/yii2-library/backend/widgets/views/input-tree/ul',
                [
                    'parents' => $children,
                    'form' => $form,
                    'model' => $model,
